...
const compruebaToken_1 = require("../middlewares/compruebaToken");
...
usuarioRutas.post('/renewToken', compruebaToken_1.compruebaToken, usuario_controlador_1.default.prototype.renuevaToken);
